    ...
    <div class="bg-white h-full dark:bg-gray-700">
      ...
      <nav class="mt-6">
        <div>
          ...
          <router-link class="w-full text-gray-400 flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start hover:text-gray-800 border-l-4 border-transparent" to="/account">
            <span class="text-left">
